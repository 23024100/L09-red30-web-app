...
} // function finds the category object whos id property matches the id passed through the function
// object returned holds name and session data that needs to be displayed on the page
